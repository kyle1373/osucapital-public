alter table "public"."trades" add column "sold_while_banned" boolean not null default false;

set check_function_bodies = off;

CREATE OR REPLACE FUNCTION public.sell_all_shares(p_user_id integer, p_stock_id integer, p_percent_return real, stock_banned boolean)
...
BEGIN
    ...
    VALUES (p_user_id, p_stock_id, 'sell', v_total_shares_sold, v_coins_earned, 0, v_net_profit, v_coins_earned, 1, stock_banned);
