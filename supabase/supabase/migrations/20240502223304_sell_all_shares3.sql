drop function if exists "public"."sell_all_banned_shares"(p_user_id integer, p_stock_id integer);

set check_function_bodies = off;

CREATE OR REPLACE FUNCTION public.sell_all_shares(p_user_id integer, p_stock_id integer, p_percent_return real)
