      ...
      <SidebarWrapper>
        <main className="h-full w-full py-6 px-4">
          ...
          <Description>
            ...
            {COINS.StartingCoins} coins, and traders can increase their coin
            total by making good investments in players.
          </Description>
          ...
          <Description>
            ...
            increases at a greater rate the higher it is. For example, an
            increase in PP from 10,000 {"->"} 11,000 results in a higher
            increase in share price than 1,000 {"->"} 2,000. PP follows{" "}
            <Link
          ...
          <Description>
            Rank Improvement Score takes in the player's rank improvement over
            the last 30 days, with more recent days being weighted heavier than
            older days. The reason why we have this component is to make it so
            player stock prices increase more. We noticed that if we only
            incorporated PP Score, player stock prices would not increase as
            much. This Rank Improvement Score is used to make stocks more
            volatile.
          </Description>
          <Subtitle>
          ...
          <Description>
            ...
            order to be tradable. This includes players having a certain amount
            of recent playcount, an old enough account, and more. In cases where
            this somehow does not get detected, we reserve the right to revert a
            player's coin totals if they abuse investing into cheaters or multi
            accounts. As a side note: if you invest into a cheater / multi
            account and they get banned, your shares are automatically worth 0
            coins. Don't invest into cheaters {":)"}
          </Description>
          ...
          <Description>
            ...
            players PP updates in real time. Most traders who use osu! capital
            use these Discord bot channel in our server to get realtime updates
            on player improvements. You can{" "}
            <Link
              className="text-blue-400 underline hover:text-blue-500 duration-300 transition"
              href={LINKS.Discord}
            >
          ...
          <Description>
            ...
            saved, and badges for the top-ranked traders will be on their
            profile.
          </Description>
          ...
          <Description>
            ...
            ! The team checks the chat often and is used as our primary source
            of contact.
          </Description>
        </main>
      </SidebarWrapper>
