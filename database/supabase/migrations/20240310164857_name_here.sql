alter table "public"."trades" alter column "coins" set data type numeric(100,2) using "coins"::numeric(100,2);

alter table "public"."trades" alter column "coins_with_taxes" set data type numeric(100,2) using "coins_with_taxes"::numeric(100,2);

alter table "public"."trades" alter column "num_shares" set data type numeric(100,2) using "num_shares"::numeric(100,2);

alter table "public"."trades" alter column "profit" set data type numeric(100,2) using "profit"::numeric(100,2);

alter table "public"."users" alter column "coins_held" set data type numeric(100,2) using "coins_held"::numeric(100,2);

alter table "public"."users_history" alter column "net_worth" set data type numeric(100,2) using "net_worth"::numeric(100,2);

alter table "public"."users_history" alter column "total_coins" set data type numeric(100,2) using "total_coins"::numeric(100,2);

alter table "public"."users_stocks" alter column "num_shares" set data type numeric(100,2) using "num_shares"::numeric(100,2);
...
BEGIN
  ...
  SELECT
    ...
    u.osu_picture,
    u.osu_banner,
    (u.coins_held + COALESCE(SUM(us.num_shares * s.share_price), 0))::numeric(100,2) AS total_coins,
    (
...
BEGIN
  ...
  WITH ranked_users AS (
    SELECT 
      u.user_id,
      u.coins_held,
      (COALESCE(SUM(s.share_price * us.num_shares), 0))::numeric(100,2) AS coins_invested,
