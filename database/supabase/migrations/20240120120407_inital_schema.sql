alter type "public"."leaderboardentrytype" rename to "leaderboard_entry_type";

alter type "public"."stockdetailstype" rename to "stock_details_type";

alter type "public"."userdetailstype" rename to "user_details_type";

alter table "public"."users" add column "show_trades" boolean not null default true;
...
ALTER TYPE user_details_type ADD ATTRIBUTE show_trades BOOLEAN;